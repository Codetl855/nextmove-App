...
const EditUserProfie: React.FC<Props> = ({ route }) => {
    ...
    useEffect(() => {
        if (agentData) {
            ...
            if (agentData?.profile_image_url) {
                setExistingImageUrl(agentData?.profile_image_url)
            }
        }
    }, [agentData])
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (error) {
                ...
                showErrorToast(`Failed to update agent - ${error}`)
                return
            }
            ...
            setLoader(false)
            showErrorToast(`Failed to update profile - ${err}`)
